...
describe("FOO BAR", () => {
    ...
    it("chordictionary.isValidTuning()", () => {
    ...
    it("guitar.getChordInfo() with " + chords.length + " chords", () => {
