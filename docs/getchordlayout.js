...
for (var i = 0; i < chords.length; i++) {
    ...
    document.getElementById("layouts").innerHTML += "<div style='width:140px;height:180px;margin:20px;float:left'>" + guitar.getChordLayout(result.tab.join(""), result.chords[0]) + "</div>";
}
